...
public partial class MainWindowViewModel : ViewModelBase, IDisposable
{
    ...
    private void NavigateToView(string viewName)
    {
        CurrentView = viewName switch
        {
            ...
            "OpCoTable" => new ReferenceTables.OpCoTableViewModel(_dataService),
            "StatusTable" => new ReferenceTables.StatusTableViewModel(_dataService),
            "ManufacturerTable" => new ReferenceTables.ManufacturerTableViewModel(_dataService),
            "DeviceCodeTable" => new ReferenceTables.DeviceCodeTableViewModel(_dataService),
            "LookupCodeTable" => new ReferenceTables.LookupCodeTableViewModel(_dataService),
            "PurchaseCodeTable" => new ReferenceTables.PurchaseCodeTableViewModel(_dataService),
